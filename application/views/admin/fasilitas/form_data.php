        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="<?= base_url('Admin/Fasilitas') ?>" class="btn btn-warning"><i class="fas fa-backward"></i> Kembali</a>
                            <br><br>
                            <form action="<?= base_url('Admin/Fasilitas/process') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input placeholder="Nama fasilitas" type="text" name="nama_fasilitas" class="form-control  <?= form_error('nama_fasilitas') != null ? 'border border-danger' : '' ?>" value="<?= $row->nama_fasilitas != null ? $row->nama_fasilitas : set_value('nama_fasilitas') ?>">
